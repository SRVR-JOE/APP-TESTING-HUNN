...
const navItems: NavItem[] = [
  ...
  { id: VIEWS.MULTICAST_FLOW, label: 'Multicast', icon: Radio },
  { id: VIEWS.REDUNDANCY, label: 'Redundancy', icon: Shield },
  { id: VIEWS.CABLE_SCHEDULE, label: 'Cables', icon: Cable },
  { id: VIEWS.OFFLINE_DESIGN, label: 'Offline Design', icon: PenTool },
  { id: VIEWS.REMOTE_MONITOR, label: 'Remote Monitor', icon: Satellite },
  { id: VIEWS.AUDIT_TRAIL, label: 'Audit Trail', icon: ClipboardList },
